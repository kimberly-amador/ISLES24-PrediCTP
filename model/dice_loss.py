...
class Dice(object):
    ...
    1. probabilistic for each label
    ...
    def __init__(self, nb_labels,
                 ...
                 vox_weights=None,
                 crop_indices=None,
                 area_reg=0.1):  # regularization for bottom of Dice coefficient
        """
    ...
    def dice(self, y_true, y_pred):
        ...
        # sum_dim = 1 ... sum_dim = (1, 2, 3) for 3D split?
        sum_dim = (1, 2)  # 2D split
...
def batch_gather(reference, indices):
    ...
    Batch-wise gathering of row indices.
